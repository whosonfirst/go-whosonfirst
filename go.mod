...
require (
	...
	github.com/aaronland/gocloud v1.3.1
	...
	github.com/sfomuseum/go-database v0.0.19
	...
	github.com/whosonfirst/go-geojson-svg v0.0.7
	...
	github.com/whosonfirst/go-whosonfirst-github v0.9.6
