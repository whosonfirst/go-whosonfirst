...
// to emitting records with a `go-whosonfirst/v4/iterate.Iterator` instance.
func DefaultFlagSet() *flag.FlagSet {
	...
	fs.Usage = func() {
		fmt.Fprintf(os.Stderr, "Emit records in one or more whosonfirst/go-whosonfirst/v4/iterate.Iterator sources as structured data.\n")
